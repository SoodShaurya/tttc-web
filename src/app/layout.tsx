...
export const metadata = {
  ...
  title: 'The Things They Carried - A Memorial',
                ...
                <header className="sticky-header">
                  <div className="header-row grid md:grid-cols-5">
                    ...
                    <div className="flex md:col-span-3">
                      {' '}
                      {/* Removed border-r-2 border-[#6e7b99] */}
                      <div className="header-box logo-box">
                        {' '}
                        {/* Fixed width defined in globals.css */}
                        <img
                          src="/fixedlogo.png"
                          alt="Logo"
                      ...
                      <div className="header-box spacer-box cross-dots h-24">
                        {' '}
                        {/* Re-using spacer-box for flex-grow, ensuring height, added cross-dots */}
